...
export default async function Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  // Revocación de acceso (FASE 4, FR-007): un miembro desactivado (o eliminado)
  // pierde el dashboard en su siguiente navegación aunque su JWT siga vivo.
  if (ctx && sessionUser?.status !== "ACTIVE") {
    redirect("/login");
  }
