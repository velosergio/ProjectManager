...
const currencies = {
  EUR: {
    label: "Saldo en euros",
  },
  GBP: {
    label: "Saldo en libras",
  },
  USD: {
...
export function AccountAllocation() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-normal">Distribución de cuentas</CardTitle>
        <CardAction>
