...
const shortcuts = [
  ...
  { id: 3, label: "Pagar facturas", icon: Banknote },
  { id: 4, label: "Historial", icon: History },
  { id: 5, label: "Móvil", icon: Smartphone },
  { id: 6, label: "Electricidad", icon: Lightbulb },
  { id: 7, label: "Agua", icon: Droplet },
  { id: 8, label: "Más", icon: MoreHorizontal },
];
...
export function Shortcuts() {
  return (
    <div className="flex flex-col gap-4">
      <Card>
        <CardHeader>
          <CardTitle className="font-normal">Transferencia rápida</CardTitle>
          <CardAction>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-normal">Atajos</CardTitle>
        </CardHeader>
        <CardContent>
