...
const stageOptions = ["all", "Propuesta enviada", "Descubrimiento", "Negociación", "Calificada"] as const;
const healthOptions = ["all", "En curso", "Requiere revisión", "En riesgo", "En pausa"] as const;
...
export function RecentOpportunities() {
  ...
  return (
    <section>
      <Card>
        <CardHeader>
          <CardTitle className="leading-none">Oportunidades recientes</CardTitle>
          <CardDescription>
            Sigue los leads calificados a través de las etapas de descubrimiento, propuesta y cierre.
          </CardDescription>
          <CardAction>
                  ...
                  >
                    {stageOptions.map((option) => (
                      <DropdownMenuRadioItem key={option} value={option}>
                        {option === "all" ? "Todas las etapas" : option}
                      </DropdownMenuRadioItem>
                    ))}
                  </DropdownMenuRadioGroup>
                </DropdownMenuContent>
                ...
                <DropdownMenuContent align="end" className="w-40">
                  ...
                  >
                    {healthOptions.map((option) => (
                      <DropdownMenuRadioItem key={option} value={option}>
                        {option === "all" ? "Cualquier salud" : option}
                      </DropdownMenuRadioItem>
                    ))}
                  </DropdownMenuRadioGroup>
                </DropdownMenuContent>
