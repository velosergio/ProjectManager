...
export function MeetingsAndGoal() {
  return (
    <section className="grid grid-cols-1 gap-4 xl:grid-cols-12">
      ...
      <Card className="xl:col-span-4">
        <CardHeader>
          <CardTitle>Meta mensual de propuestas</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-1">
          <div className="flex items-end justify-between gap-3">
            ...
            <div className="text-muted-foreground text-sm tabular-nums">{proposalGoal} objetivo</div>
          </div>
          ...
          <p className="text-muted-foreground text-sm">
            {proposalProgressPercentage}&nbsp;% de la meta de propuestas de este mes alcanzado.
          </p>
        </CardContent>
      </Card>
    </section>
