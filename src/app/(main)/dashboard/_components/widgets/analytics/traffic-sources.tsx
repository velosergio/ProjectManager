...
const sourcesData: TrafficSourceDatum[] = [
  { label: "89.4k", source: "Búsqueda orgánica", visitors: 89_400 },
  { label: "55.2k", source: "Directo", visitors: 55_200 },
  { label: "38.1k", source: "Redes sociales", visitors: 38_100 },
  { label: "30.4k", source: "Referidos", visitors: 30_400 },
  { label: "22.7k", source: "De pago", visitors: 22_700 },
];

const campaignsData: TrafficSourceDatum[] = [
  { label: "16.8k", source: "Lanzamiento de primavera", visitors: 16_800 },
  { label: "12.0k", source: "Boletín", visitors: 12_000 },
  { label: "7.7k", source: "Retargeting", visitors: 7700 },
  { label: "5.9k", source: "Búsqueda de marca", visitors: 5900 },
  { label: "4.3k", source: "Socios", visitors: 4300 },
];
...
export function TrafficSources() {
  return (
    <Card className="h-full gap-2">
      <CardHeader>
        <CardTitle className="font-normal">Fuentes de tráfico</CardTitle>
        <CardAction>
